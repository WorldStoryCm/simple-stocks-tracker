...
const features: Feature[] = [
  {
    ...
    body: "KPIs for the month and all-time, monthly and yearly goals with live progress, dividends, and a cumulative P/L chart you can toggle between 1M, 3M, 1Y, and all-time.",
    bullets: ["Monthly + yearly profit goals", "Cumulative P/L chart", "Recent trades, dividends, P/L by symbol"],
    label: "Dashboard — KPIs, goals, cumulative P/L, dividends",
  },
  {
    slot: "imports",
    eyebrow: "Imports",
    title: "Preview broker exports before they touch your ledger.",
    body: "Start with Revolut CSV exports. The importer shows rows that will be added, rows already matched, possible duplicates, ignored cash transfers, and anything that needs review.",
    bullets: ["Revolut CSV import", "Matched / missing / review states", "Batch history with rollback"],
    label: "Imports — preview matched and missing broker rows",
  },
  {
    slot: "positions",
    eyebrow: "Positions",
  ...
  },
  {
    slot: "dividends",
    eyebrow: "Dividends",
    title: "Income stays separate from trade P/L.",
    body: "Dividends, dividend tax, fees, deposits, and withdrawals are imported as cash events instead of being forced into the trade ledger.",
    bullets: ["Separate dividend tab", "Gross, tax, and net totals", "Cash-balance impact from broker rows"],
    label: "Dividends — gross, tax, and net income",
  },
  {
    slot: "performance",
    eyebrow: "Performance",
