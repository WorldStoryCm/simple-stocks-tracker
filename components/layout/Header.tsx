...
export function Header() {
  ...
  return (
    <header className="sticky  justify-between top-0 z-30 flex h-16 items-center gap-3 border-b border-border bg-[color:var(--background)]/85 backdrop-blur-xl px-4 md:px-6">
      <div/>
